...
if 'product' in st.session_state:
    ...
    st.markdown("*Reason for Recommendation*: " + str(product['reason_for_recommendaion']))
    st.markdown("*Relevance Score*: " + str(product['search_relevance_score']))
    st.markdown("*Product Description*: " + str(product['product_description']))
